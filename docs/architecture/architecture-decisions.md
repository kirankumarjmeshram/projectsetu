...
Current established constraints are modular responsibility boundaries, deterministic domain calculations, provider-neutral infrastructure, strict TypeScript, and source provenance for financial and scheme rules. ADR 0001 accepts `decimal.js`, branded decimal strings, percent-point percentages, and decimal-string boundaries. Database and all other provider choices remain open.
