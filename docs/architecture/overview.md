...
The repository implements a Next.js application shell, a development landing page, quality tooling, canonical provider-independent TypeScript contracts, Core Financial Engine Phase 1 arithmetic identities, a deterministic term-loan repayment engine, a revenue/operating-expense projection engine, an asset-wise depreciation engine, and a projected profit-and-loss composition engine described in [the domain model](../domain/domain-model.md). Product workflows, persistence, cash-flow and balance-sheet generation, viability metrics, and other advanced financial calculations remain unimplemented.
...
Domain modules are organized around project identity, applicants and business entities, costs, operations, projections, working capital, financing, loans, depreciation, profit and loss, subsidy, scheme versions, financial contracts, sensitivity, documents, reports, provenance, and validation. Cohesive modules expose their own public contracts; there is intentionally no global barrel file.
