...
ProjectSetu is an early-stage application for creating bankable project reports, subsidy-based DPRs, financial projections, and document-supported estimates. The repository contains engineering foundations, canonical domain contracts, Core Financial Engine Phase 1 arithmetic identities, a deterministic term-loan repayment engine, a revenue/operating-expense projection engine, an asset-wise depreciation engine, a projected profit-and-loss composition engine, and an indirect-method cash-flow composition engine. Business workflows, scheme rules, balance-sheet generation, viability metrics, document processing, and AI features are not implemented.
